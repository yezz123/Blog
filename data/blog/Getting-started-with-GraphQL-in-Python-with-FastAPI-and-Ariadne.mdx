...
__Note:__ If you don’t have it installed, get it [here](https://www.python.org/downloads/).
...
__Note:__ Understand the difference between ASGI and WSGI [Blog by Raoof Naushad](https://medium.com/analytics-vidhya/difference-between-wsgi-and-asgi-807158ed1d4c).
...
__Note:__ create a dynamic Source Review for Blog, by using RabbitMQ.
